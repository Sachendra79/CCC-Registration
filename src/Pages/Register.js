       ...
       <div className='register-content'>
        ...
        <div className="WhiteCard_Register">
          ...
          <form action='/register/mainregister'>
           <button className='button_register bg-[black] rounded-[10px] absolute left-[36.5%] top-[73%] w-[300px] h-[64px] font-poppins text-white font-normal text-2xl'>Register Now!</button>
          </form>
        </div>
        </div>
