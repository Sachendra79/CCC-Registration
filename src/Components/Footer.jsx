  ...
  return (
    <div className='footer-container flex flex-col'>
      ...
      <div className='picture-card text-[#fff] bg-[#312f2f] '>
       ...
       <div className='picture-card text-[#fff] bg-[#312f2f] '>
        <div className='picture w-40 bg-[#312f2f] '><img className='rounded-xl bg-[#312f2f]' src={Sarthak} alt="" /></div>
       <div className='picture-content w-40 bg-[#312f2f] '>
        <p className='bg-[#312f2f] mx-3 '>Sarthak Srivastava</p>
        <p className='bg-[#312f2f] mx-2'>(Event Coordinator)</p>
       </div>
      ...
      <div className='footer-below flex justify-evenly flex-wrap'>
          <div className='footer-links text-[#fff]'>
           <div className='flex gap-3' >
            <div className='logo-image'> <img src={akgec} alt="" /></div>
            <div className='logo-para'> <p>Ajay Kumar Garg Engineering College, 27th Km milestone NH-24 Delhi-Hapur Bypass, Adhyatmik Nagar Ghaziabad.</p></div>

           </div>
           <div className='flex gap-3'>
            <div className='logo-image'><img src={location} alt="" /></div>
            <div className='logo-para'> <p>If you require help or have any inquiries, feel free to reach out - we're here to support you. CCC Lab, 3th floor CSIT Block</p></div>

           </div>
          </div>

          <div className='contact flex text-[#fff] flex-col gap-1'>
